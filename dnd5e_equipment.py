...
trinkets = {
    ...
    7: "A pair of knucklebone dice, each with a skull symbol on the side normally showing 6 pips",
    ...
    34: "A rectangular device with two tiny metal cups on one end that throws sparks when wet",
    ...
    98: "A glass jar containing lard with a label that read \"Griffon Grease\"",
