...
trinkets = {
    ...
    7: "A pair of knucklebone dice, each with a skull symbol on the side \
        normally showing 6 pips",
    8: "A small idol depicting a nightmarish creature that gives you \
        unsettling dreams when you sleep near it",
    9: "A rope necklace from which dangles 4 mummified elf fingers",
    10: "The deed for a parcel of land in a realm unknown to you",
    11: "A 1 oz block made from an unknown material",
    ...
    18: "A 1 lb egg with a bright red shell",
    19: "A pipe that blows bubbles",
    20: "A glass jar containing a weird bit of flesh floating in pickling \
         fluid",
    21: "A tiny gnome-crafted music box that plays a song you dimly remember \
         from your childhood",
    ...
    30: "A blank book whose pages refuse to hold ink, chalk, graphite, or any \
         other substance or marking",
    31: "A silver badge in the shape of a 5-pointed star",
    32: "A knife that belonged to a relative",
    33: "A glass vial filled with nail clippings",
    34: "A rectangular device with two tiny metal cups on one end that throws \
         sparks when wet",
    ...
    40: "A gemstone that looks like a lump of coal when examined by anyone but \
         you",
    41: "A scrap of cloth from an old banner",
    42: "A rank insignia from a lost legionnaire",
    43: "A tiny silver bell without the clapper",
    ...
    47: "A metal can that has no opening but sounds as if it is filled with \
    ...
    73: "The shell of an egg painted with scenes of human misery in disturbing \
         detail",
    ...
    86: "An empty silver snuffbox bearing an inscription on the surface that \
         says \"dreams\"",
    87: "An iron holy symbol devoted to an unknown god",
    88: "A book that tells the story of a legendary hero's rise and fall with \
    ...
    93: "An empty wine bottle bearing a pretty label that says \"The Wizard of \
         Wines Winery, Red Dragon Crush, 331422-W\"",
    ...
    97: "A tiny mechanical crab or spider that moves about when it's not being \
         observed",
    98: "A glass jar containing lard with a label that read \
         \"Griffon Grease\"",
...
def chooseTrinket():
    """
    chooseTrinket function.

    Select a random trinket for the character to start with.
    """
    trinketNum = random.randint(1, 100)
    trinket = trinkets[trinketNum]

    return trinket, trinketNum
