...
backgrounds = {
    "acolyte": {
        ...
        "equipment": ["holy symbol", "prayer book", "5 sticks of incense", "vestments", "set of common clothes"],
        "wealth": {"gp": 15},
        "feature": "Shelter of the Faithful - As an acolyte, you command the respect of those who share your faith, and you can perform the religious ceremonies of your diety. You and your adventuring companions can expect to receive free healing and care at a temple, shribe, or other established presence of your faith, though you must provide material components needed for your spells. Those who share your religion will support you (but only you) at a modest lifestyle. \n You might also have ties to a specific pantheon, and you have a residence there. This could be the temple where you used to serve, if you remain on good terms with it, or a temple where you have found a new home. While near your temple, you can call upon the priests for assistance, provided the assistance you ask if not hazardous and you remain in good standing with your temple.",
        "misc": {},
        "personality": {
    ...
    "criminal": {
        ...
        "wealth": {"gp": 15},
        "feature": "Criminal Contact - You have a reliable and trustworthy contact who acts as your liason to a network of other criminals. You know how to get messages to and from your contact, even over great distances; specifically, you know the local messengers, corrupt caravan masters, and seedy sailors who can deliver messages for you.",
        "misc": {
            "varient": {
                1: "blackmailer",
                2: "burglar",
        ...
        "ideal": {
            ...
            5: "People - I'm loyal to my friends, not to any ideais, and everyone else can take a trip down the Styx for all I care. (Neutral)",
    ...
    "entertainer": {
        ...
        "language": "",
        "equipment": ["a musical instrument", "the favor of an admirer (lock of hair, love letter, trinket, etc)", "a costume"],
        "wealth": {"gp": 15},
    ...
    "folk_hero": {
        ...
        "misc": {
            "varient": {
                ...
                8: "A lord rescinded an unpopuler decree after I led a symbolic act of protest against it.",
                9: "A celestial, fey, or similar creature gave me a blessing or revealed my secret origins.",
...
def chooseBG():
    ...
    charBGpersonality = [backgrounds[charBG]['personality'][random.randint(1, 8)], backgrounds[charBG]['personality'][random.randint(1, 8)]]
    ...
    if 'varient' in backgrounds[charBG]['misc']:
        charBGvarient = backgrounds[charBG]['misc']['varient'][random.randint(1, len(backgrounds[charBG]['misc']['varient']))]
    else:
        charBGvarient = ""
